...
3. Check the [CHANGELOG](CHANGELOG.md) and the [latest release](https://github.com/gianluca-schwekendiek/taskbar-grouping/releases) — the problem may already be fixed.

## Reporting a bug

Use the [bug report template](https://github.com/gianluca-schwekendiek/taskbar-grouping/issues/new/choose) and include:
...
Use the [feature request template](https://github.com/gianluca-schwekendiek/taskbar-grouping/issues/new/choose). Describing the problem you are trying to solve is more useful than describing the solution you have in mind — there may be a better one, or one that already exists.
