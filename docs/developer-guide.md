...
> ℹ️ **Status: v0.2.0.** All conventions and referenced components below exist in the codebase.
...
- ✅ **DI**: Register services in `*ServiceCollectionExtensions`, inject via constructor
...
- ✅ **Icon extraction fails**: Ensure the target .exe exists and is accessible (`ShellIconExtractor` catches IO/COM errors and returns null)
