...
Use GitHub's private vulnerability reporting: open the [Security tab](https://github.com/gianluca-schwekendiek/taskbar-grouping/security/advisories/new) and file a draft advisory. The report stays private between you and the maintainer, it carries the discussion and any fix alongside it, and it can be published as an advisory once a fix ships — none of which an email thread gives you.
